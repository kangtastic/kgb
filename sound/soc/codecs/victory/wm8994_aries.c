...
struct gain_info_t playback_gain_table[PLAYBACK_GAIN_NUM] = {
	{ /* COMMON */
		...
		.gain = WM8994_HPOUT1_VU | 0x34 /* -8dB */
	}, {
		.mode = PLAYBACK_HP,
...
void wm8994_record_headset_mic(struct snd_soc_codec *codec)
{
	...
	DEBUG_LOG("=============wm8994->input_source %d\n",wm8994->input_source);
...
void wm8994_set_voicecall_headset(struct snd_soc_codec *codec)
{
	...
	if(tty_mode == TTY_MODE_VCO)
	{
		wm8994_write(codec, 0x0018, 0x0118);	// Left Line Input 1&2 Volume
		wm8994_write(codec, 0x0612, 0x01C0);	// DAC2 Left Volume
	}
	else if(tty_mode == TTY_MODE_HCO || tty_mode == TTY_MODE_FULL)
	{
		wm8994_write(codec, 0x001A, 0x0108/*0x0112*/);	  // Right Line Input 1&2 Volume
		wm8994_write(codec, 0x0613, 0x01C0);	// DAC2 Right Volume
	}
	else if(loopback_mode == PBA_LOOPBACK_MODE_ON)
	{
		wm8994_write(codec, 0x001A, 0x0103);	// Right Line Input 1&2 Volume
		wm8994_write(codec, 0x0613, 0x01C0);	// DAC2 Right Volume
...
void wm8994_set_voicecall_speaker(struct snd_soc_codec *codec)
{
	...
	/* Input Path Volume */
	wm8994_write(codec, 0x0019, 0x0117);	// Left Line Input 3&4 Volume. SPK Mic using the IN2NL | DM1CDAT1
