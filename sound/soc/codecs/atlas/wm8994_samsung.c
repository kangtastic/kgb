...
#ifdef FEATURE_SS_AUDIO_CAL
    if((wm8994->cur_path == EXTRA_DOCK_SPEAKER) && (path_num != EXTRA_DOCK_SPEAKER))
    {
        wm8994_set_fsa9480_enable(0);
    }
#endif
	wm8994->codec_state |= PLAYBACK_ACTIVE;
...
static const struct snd_kcontrol_new wm8994_snd_controls[] = {
	...
	SOC_ENUM_EXT("Playback Path", path_control_enum[0],
	    ...
	    SOC_ENUM_EXT("Codec Status", path_control_enum[4],
...
static struct attribute *wm8994_call_audio_attrs[] = {
...
static struct attribute_group wm8994_call_audio_group = {
  .attrs = wm8994_call_audio_attrs,
};
...
#endif
	misc_register(&wm8994_call_audio_device);
	sysfs_create_group(&wm8994_call_audio_device.this_device->kobj,
				&wm8994_call_audio_group);
...
static int wm8994_remove(struct platform_device *pdev)
{
	...
	sysfs_remove_group(&wm8994_call_audio_device.this_device->kobj, &wm8994_call_audio_group);
	misc_deregister(&wm8994_call_audio_device);
	kfree(codec->drvdata);
