...
#ifndef _FSR_FONENAND_LLD_H_
#define _FSR_FONENAND_LLD_H_
...
typedef struct
{
    ...
    volatile UINT16   nLogOp      [FSR_FND_MAX_LOG];
    volatile UINT16   nLogPbn     [FSR_FND_MAX_LOG];
    volatile UINT16   nLogPgOffset[FSR_FND_MAX_LOG];
    volatile UINT32   nLogFlag    [FSR_FND_MAX_LOG];
} FlexONDOpLog;

/*****************************************************************************/
/* Extern variable declarations                                              */
/*****************************************************************************/
extern volatile FlexONDOpLog        gstFNDOpLog[FSR_MAX_DEVS];

/*****************************************************************************/
/* Flex-OneNAND System Configureation1 Register Values                       */
/*****************************************************************************/
#define     FSR_FND_CONF1_SYNC_READ             (UINT16) (0x8000)
#define     FSR_FND_CONF1_ASYNC_READ            (UINT16) (0x0000)

#define     FSR_FND_CONF1_BST_RD_LATENCY_3      (UINT16) (0x3000)     /*   min   */
#define     FSR_FND_CONF1_BST_RD_LATENCY_4      (UINT16) (0x4000)     /* default */
#define     FSR_FND_CONF1_BST_RD_LATENCY_5      (UINT16) (0x5000)
#define     FSR_FND_CONF1_BST_RD_LATENCY_6      (UINT16) (0x6000)
#define     FSR_FND_CONF1_BST_RD_LATENCY_7      (UINT16) (0x7000)

#define     FSR_FND_CONF1_BST_LENGTH_CONT       (UINT16) (0x0000)     /* default */
#define     FSR_FND_CONF1_BST_LENGTH_4WD        (UINT16) (0x0200)
#define     FSR_FND_CONF1_BST_LENGTH_8WD        (UINT16) (0x0400)
#define     FSR_FND_CONF1_BST_LENGTH_16WD       (UINT16) (0x0600)
#define     FSR_FND_CONF1_BST_LENGTH_32WD       (UINT16) (0x0800)     /* N/A on spare */
#define     FSR_FND_CONF1_BST_LENGTH_1KWD       (UINT16) (0x0A00)     /* N/A on spare, sync. burst block read only */

#define     FSR_FND_CONF1_ECC_ON                (UINT16) (0xFEFF)
#define     FSR_FND_CONF1_ECC_OFF               (UINT16) (0x0100)     /* (~FSR_FND_CONF1_ECC_ON) */

#define     FSR_FND_CONF1_RDY_POLAR             (UINT16) (0x0080)
#define     FSR_FND_CONF1_INT_POLAR             (UINT16) (0x0040)
#define     FSR_FND_CONF1_IOBE_ENABLE           (UINT16) (0x0020)

#define     FSR_FND_CONF1_BWPS_UNLOCKED         (UINT16) (0x0001)

#define     FSR_FND_CONF1_HF_ON                 (UINT16) (0x0004)
#define     FSR_FND_CONF1_HF_OFF                (UINT16) (0xFFFB)
#define     FSR_FND_CONF1_RDY_CONF              (UINT16) (0x0010)


/* MACROs below are used for Deferred Check Operation                         */
#define     FSR_FND_PREOP_NONE                  (0x0000)
#define     FSR_FND_PREOP_READ                  (0x0001)
#define     FSR_FND_PREOP_CPBK_LOAD             (0x0002)
#define     FSR_FND_PREOP_CACHE_PGM             (0x0003)
#define     FSR_FND_PREOP_PROGRAM               (0x0004)
#define     FSR_FND_PREOP_CPBK_PGM              (0x0005)
#define     FSR_FND_PREOP_ERASE                 (0x0006)
#define     FSR_FND_PREOP_IOCTL                 (0x0007)
#define     FSR_FND_PREOP_HOTRESET              (0x0008)
#define     FSR_FND_PREOP_ADDRESS_NONE          (0xFFFF)
#define     FSR_FND_PREOP_FLAG_NONE             FSR_LLD_FLAG_NONE
/*****************************************************************************/
/* exported common APIs                                                      */
/*****************************************************************************/
INT32   FSR_FND_Init            (UINT32         nFlag);
INT32   FSR_FND_Open            (UINT32         nDev,
                                 VOID          *pParam,
                                 UINT32         nFlag);
INT32   FSR_FND_Close           (UINT32         nDev,
                                 UINT32         nFlag);
INT32   FSR_FND_Read            (UINT32         nDev,
                                 UINT32         nPbn,
                                 UINT32         nPgOffset,
                                 UINT8         *pMBuf,
                                 FSRSpareBuf   *pSBuf,
                                 UINT32         nFlag);
INT32   FSR_FND_ReadOptimal     (UINT32         nDev,
                                 UINT32         nPbn,
                                 UINT32         nPgOffset,
                                 UINT8         *pMBuf,
                                 FSRSpareBuf   *pSBuf,
                                 UINT32         nFlag);
INT32   FSR_FND_Write           (UINT32         nDev, 
                                 UINT32         nPbn,
                                 UINT32         nPgOffset,
                                 UINT8         *pMBuf,
                                 FSRSpareBuf   *pSBuf,
                                 UINT32         nFlag);
INT32   FSR_FND_Erase           (UINT32         nDev,
                                 UINT32        *pnPbn,
                                 UINT32         nNumOfBlks,
                                 UINT32         nFlag);
INT32   FSR_FND_CopyBack        (UINT32         nDev,
                                 LLDCpBkArg    *pstCpArg,
                                 UINT32         nFlag);
INT32   FSR_FND_ChkBadBlk       (UINT32         nDev,
                                 UINT32         nPbn,
                                 UINT32         nFlag);
INT32   FSR_FND_FlushOp         (UINT32         nDev,
                                 UINT32         nDieIdx,
                                 UINT32         nFlag);
INT32   FSR_FND_GetBlockInfo    (UINT32         nDev,
                                 UINT32         nPbn,
                                 UINT32        *pBlockType,
                                 UINT32        *pPgsPerBlk);
INT32   FSR_FND_GetDevSpec      (UINT32         nDev,
                                 FSRDevSpec    *pstDevSpec,
                                 UINT32         nFlag);
INT32   FSR_FND_GetPlatformInfo (UINT32         nDev,
                               LLDPlatformInfo *pLLDPltInfo);
INT32   FSR_FND_GetPrevOpData   (UINT32         nDev,
                                 UINT8         *pMBuf,
                                 FSRSpareBuf   *pSBuf,
                                 UINT32         nDieIdx,
                                 UINT32         nFlag);
INT32   FSR_FND_IOCtl           (UINT32         nDev,
                                 UINT32         nCode,
                                 UINT8         *pBufI,
                                 UINT32         nLenI,
                                 UINT8         *pBufO,
                                 UINT32         nLenO,
                                 UINT32        *pByteRet);
INT32   FSR_FND_InitLLDStat     (VOID);
INT32   FSR_FND_GetStat         (FSRLLDStat    *pstStat);
#ifdef __cplusplus
}
#endif /* __cplusplus */
