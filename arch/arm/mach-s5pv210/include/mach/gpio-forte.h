...
//#include <mach/gpio.h>
#define CONFIG_FORTE_HW_REV02
#define CONFIG_FORTE_HW_REV03
...
#if defined (CONFIG_FORTE_HW_REV02) 
...
#else
#define GPIO_CMC_CS_28V         S5PV210_GPB(1)
#define GPIO_CMC_DO_28V		    S5PV210_GPB(2)
#define GPIO_CMC_DI_28V			S5PV210_GPB(3)
#define GPIO_CLK_DI_28V			S5PV210_GPB(4)
#define BUCK1_EN_B  			S5PV210_GPB(5)
#define BUCK1_EN_A				S5PV210_GPB(6)
#endif

#define BUCK2_EN				S5PV210_GPB(7)
...
#define FUEL_SCL_18V		    S5PV210_GPC0(3)  // GPIO_FUEL_SCL_18V
#define FUEL_SCL_18V_AF	        3

#define FUEL_SDA_18V		    S5PV210_GPC0(4)  // GPIO_FUEL_SDA_18V
...
#define GPIO_AP_SDA_28V_AF		2
#define GPIO_USB_SDA_28V		GPIO_AP_SDA_28V
#define GPIO_USB_SDA_28V_AF		2
#define GPIO_AP_SCL_28V			S5PV210_GPD1(3)
#define GPIO_AP_SCL_28V_AF		2
#define GPIO_USB_SCL_28V		GPIO_AP_SCL_28V
#define GPIO_USB_SCL_28V_AF		2
#endif
...
#else
#define GPIO_CMC_SDIO_CMD		S5PV210_GPG0(0)
#define GPIO_CMC_SDIO_CLK_AF	2
#define GPIO_CMC_SDIO_CMD		S5PV210_GPG0(1)
#define GPIO_CMC_SDIO_CMD_AF	2
#endif
...
#else
#define GPIO_DISPLAY_SI         S5PV210_GPG0(2)
#define GPIO_DISPLAY_SI_AF		S3C_GPIO_SFN(1)		// forte_temp
#endif
...
#else
#define GPIO_CMC_SDIO_D0		S5PV210_GPG0(3)
#define GPIO_CMC_SDIO_D0_AF		2

#define GPIO_CMC_SDIO_D1		S5PV210_GPG0(4)
#define GPIO_CMC_SDIO_D1_AF		2

#define GPIO_CMC_SDIO_D2		S5PV210_GPG0(5)
#define GPIO_CMC_SDIO_D2_AF		2

#define GPIO_CMC_SDIO_D3		S5PV210_GPG0(6)
#define GPIO_CMC_SDIO_D3_AF		2
#endif
...
#else
#define GPIO_T_FLASH_EN		S5PV210_GPG2(2)
#endif
...
#else
#define GPIO_DISPLAY_CLK        S5PV210_GPG3(0)
#define GPIO_DISPLAY_CLK_AF		S3C_GPIO_SFN(1)		// forte_temp
#endif

#define GPIO_GPG31              S5PV210_GPG3(1)

#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_DISPLAY_BL_EN		S5PV210_GPG3(2)
#define GPIO_TA_CURRENT_SEL_AP         S5PV210_GPG3(3)
#define GPIO_BT_WAKE			S5PV210_GPG3(4)
#define GPIO_GPG35			S5PV210_GPG3(5)
#define GPIO_GPG36			S5PV210_GPG3(6)
#else
#define GPIO_DISPLAY_RST		S5PV210_GPG3(2)
#define GPIO_MICBIAS_EN         S5PV210_GPG3(3)
#define GPIO_BT_WAKE			S5PV210_GPG3(4)
#define GPIO_NWLAN_WAKE			S5PV210_GPG3(5)
#define GPIO_DISPLAY_ID			S5PV210_GPG3(6)
#endif
...
#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_3P_SEND_END		S5PV210_GPH1(1)
#define GPIO_3P_SEND_END_AF 	0
#else
...
#define GPIO_nINT_ONEDRAM_AP_AF	0xF		// forte_temp

#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_WLAN_HOST_WAKE		S5PV210_GPH1(4)
#define GPIO_WLAN_HOST_WAKE_AF		0xF
#define GPIO_EAR_SEND_END		S5PV210_GPH1(5) // SEND_END
#define GPIO_EAR_SEND_END_AF	0xFF
#define GPIO_BT_HOST_WAKE		S5PV210_GPH1(6)
#else
#define GPIO_CMC_RST			S5PV210_GPH1(4)
#define GPIO_UART_SEL			S5PV210_GPH1(5)
#define GPIO_S5PV210_GPH1 		S5PV210_GPH1(6)
#define GPIO_S5PV210_GPH1_AF 	1
#endif
...
#else
#define GPIO_T_FLASH_DETECT		S5PV210_GPH3(5)
#define GPIO_EAR_SEND_END		S5PV210_GPH3(6) // SEND_END
#define GPIO_EAR_SEND_END_AF	0xFF
...
#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_POPUP_WN_EN	S5PV210_GPJ0(0) 
#define GPIO_GPJ01			S5PV210_GPJ0(1)
#define GPIO_GPJ02  		S5PV210_GPJ0(2)
#define GPIO_GPJ03 		S5PV210_GPJ0(3)
#define GPIO_GPJ04    		S5PV210_GPJ0(4)
#else
#define GPIO_TA_CURRENT_SEL_AP	S5PV210_GPJ0(0) // GPIO_TA_CURRENT_SEL
#define GPIO_ACC_INT			S5PV210_GPJ0(1)
#define GPIO_BOOT_MODE  		S5PV210_GPJ0(2)
...
#define GPIO_CAM_MEGA_nRST		S5PV210_GPJ1(5) // CAM_RST
...
#else
#define GPIO_USB_SEL    		S5PV210_GPJ2(0)
#define GPIO_BL_SCL_28V         S5PV210_GPJ2(1)
#define GPIO_BL_SCL_28V_AF      2
#define GPIO_BL_SDA_28V         S5PV210_GPJ2(2)
...
#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_GPJ24				S5PV210_GPJ2(4) // ALS_ON (Proximity Sensor)
#else
#define GPIO_PS_ON				S5PV210_GPJ2(4) // ALS_ON (Proximity Sensor)
#endif

#define GPIO_GPJ25				S5PV210_GPJ2(5)

#define GPIO_GPJ26			S5PV210_GPJ2(6)

#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_MASSMEMORY_EN              S5PV210_GPJ2(7)
#else
#define GPIO_GPJ27              S5PV210_GPJ2(7)
#endif
...
#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_BL_SDA_28V         S5PV210_GPJ3(4)
#define GPIO_BL_SDA_28V_AF      2
#define GPIO_BL_SCL_28V          S5PV210_GPJ3(5)
#define GPIO_BL_SCL_28V_AF      2
...
#define GPIO_USB_SDA_28V		GPIO_AP_SDA_28V
#define GPIO_USB_SDA_28V_AF		2
#define GPIO_MSENSE_SDA_28V     GPIO_USB_SDA_28V
...
#define GPIO_USB_SCL_28V		GPIO_AP_SCL_28V
#define GPIO_USB_SCL_28V_AF		2
#define GPIO_MSENSE_SCL_28V     GPIO_AP_SCL_28V
...
#else
#define GPIO_MSENSE_SCL_28V     S5PV210_GPJ3(4)
#define GPIO_MSENSE_SCL_28V_AF  2
#define GPIO_MSENSE_SDA_28V     S5PV210_GPJ3(5)
#define GPIO_MSENSE_SDA_28V_AF  2
#define GPIO_AP_PMIC_SCL		S5PV210_GPJ3(6)
#define GPIO_AP_PMIC_SDA	    S5PV210_GPJ3(7)
#define GPIO_KEYSENSE6			S5PV210_GPJ4(0)
#define GPIO_KEYSENSE6_AF		3
#define GPIO_KEYSENSE5			S5PV210_GPJ4(1)
#define GPIO_KEYSENSE5_AF		3
#define GPIO_KEYSCAN7			S5PV210_GPJ4(2)
#define GPIO_KEYSCAN7_AF		3
#define GPIO_SUB_KEY_LED_EN     S5PV210_GPJ4(2) 
#define GPIO_KEYSCAN6			S5PV210_GPJ4(3)   
#define GPIO_KEYSCAN6_AF		3
#define GPIO_MAIN_KEY_LED_EN    S5PV210_GPJ4(3)
#endif

#define GPIO_GPJ44				S5PV210_GPJ4(4)

#if defined (CONFIG_FORTE_HW_REV03)
#define GPIO_MAIN_KEY_LED_REV03_EN    S5PV210_MP04(1)
#define GPIO_SUB_KEY_LED_REV03_EN    GPIO_MAIN_KEY_LED_REV03_EN
#endif

#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_MAIN_KEY_LED_EN    S5PV210_MP01(0)
#define GPIO_SUB_KEY_LED_EN     GPIO_MAIN_KEY_LED_EN
#else
#define GPIO_CS_N   			S5PV210_MP01(0)
#endif

#define GPIO_DISPLAY_CS			S5PV210_MP01(1) // LCD_CS
#define GPIO_DISPLAY_CS_AF		S3C_GPIO_SFN(1)		// forte_temp
...
#define GPIO_C111_DPRAM_OE_N	S5PV210_MP01(6)
#define GPIO_C111_DPRAM_WE_N	S5PV210_MP01(7)
#define GPIO_C111_DPRAM_LB		S5PV210_MP02(0)
#define GPIO_C111_DPRAM_UB		S5PV210_MP02(1)
#endif
...
#else
#define GPIO_ST_ADVB_R			S5PV210_MP03(2)
...
#define GPIO_MP055		S5PV210_MP05(5)
...
#else
#define GPIO_C111_DPRAM_A0		S5PV210_MP04(0)
#define GPIO_C111_DPRAM_A1		S5PV210_MP04(1)
#define GPIO_C111_DPRAM_A2		S5PV210_MP04(2)
#define GPIO_C111_DPRAM_A3		S5PV210_MP04(3)
#define GPIO_C111_DPRAM_A4		S5PV210_MP04(4)
#define GPIO_C111_DPRAM_A5		S5PV210_MP04(5)
#define GPIO_C111_DPRAM_A6		S5PV210_MP04(6)
#define GPIO_C111_DPRAM_A7		S5PV210_MP04(7)
#define GPIO_C111_DPRAM_A8		S5PV210_MP05(0)
#define GPIO_C111_DPRAM_A9	    S5PV210_MP05(1)
#define GPIO_C111_DPRAM_A10		S5PV210_MP05(2)
#define GPIO_C111_DPRAM_A11		S5PV210_MP05(3)
#define GPIO_C111_DPRAM_A12		S5PV210_MP05(4)
#define GPIO_C111_DPRAM_A13		S5PV210_MP05(5)
#define GPIO_AP_SDA_18V			S5PV210_MP05(6)
#define GPIO_AP_SCL_18V			S5PV210_MP05(7)
#define GPIO_C111_DPRAM_D0		S5PV210_MP06(0)
#define GPIO_C111_DPRAM_D1		S5PV210_MP06(1)
#define GPIO_C111_DPRAM_D2		S5PV210_MP06(2)
#define GPIO_C111_DPRAM_D3		S5PV210_MP06(3)
#define GPIO_C111_DPRAM_D4		S5PV210_MP06(4)
#define GPIO_C111_DPRAM_D5		S5PV210_MP06(5)
#define GPIO_C111_DPRAM_D6		S5PV210_MP06(6)
#define GPIO_C111_DPRAM_D7		S5PV210_MP06(7)
#define GPIO_C111_DPRAM_D8		S5PV210_MP07(0)
#define GPIO_C111_DPRAM_D9		S5PV210_MP07(1)
#define GPIO_C111_DPRAM_D10		S5PV210_MP07(2)
#define GPIO_C111_DPRAM_D11		S5PV210_MP07(3)
#define GPIO_C111_DPRAM_D12		S5PV210_MP07(4)
#define GPIO_C111_DPRAM_D13		S5PV210_MP07(5)
#define GPIO_C111_DPRAM_D14		S5PV210_MP07(6)
#define GPIO_C111_DPRAM_D15		S5PV210_MP07(7)
#endif
...
#else
#define GPIO_ALS_SCL_28V        GPIO_BL_SCL_28V
#define GPIO_ALS_SCL_28V_AF      2
#define GPIO_ALS_SDA_28V        GPIO_BL_SDA_28V
#define GPIO_ALS_SDA_28V_AF      2
#endif
...
#if defined (CONFIG_FORTE_HW_REV02)
#define GPIO_WLAN_WAKE			GPIO_WLAN_BT_EN
#define GPIO_WLAN_WAKE_AF		1
#else
// forte_temp
#define GPIO_WLAN_WAKE			S5PV210_GPG3(5)
#define GPIO_WLAN_WAKE_AF		1
#define GPIO_BUCK_1_EN_A		S5PV210_GPB(6)		// forte_temp
#define GPIO_BUCK_1_EN_B		S5PV210_GPB(3)		// forte_temp
#endif

#define GPIO_BUCK_2_EN			S5PV210_GPB(7)		// forte_temp


// dummies
#define GPIO_DUMMY              GPIO_GPD00
...
#define GPIO_GRIP_SDA_28V		GPIO_DUMMY
#define GPIO_GRIP_SCL_28V		GPIO_DUMMY

#ifdef CONFIG_FORTE_HW_REV02   //HYH_20101112 : For Rev 0.2
#define GPIO_EAR_SEND_END_OPEN  GPIO_3P_SEND_END
#define GPIO_EAR_SEND_END_OPEN_AF 0xFF
#else
#define GPIO_EAR_SEND_END_OPEN  GPIO_DUMMY
#define GPIO_EAR_SEND_END_OPEN_AF 0xFF
#endif
...
//[dummies]  forte_temp
#define GPIO_CODEC_XTAL_EN		S5PV210_GPIO_END // S5PV210_GPJ2(3)
#define GPIO_FM_INT				S5PV210_GPIO_END // S5PV210_GPJ2(4)
#define GPIO_FM_RST				S5PV210_GPIO_END // S5PV210_GPJ2(5)
#define GPIO_EARPATH_SEL		S5PV210_GPIO_END // S5PV210_GPJ2(6)
